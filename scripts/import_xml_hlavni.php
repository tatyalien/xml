...
$textOk = '';
$textError = '';
$statistika = $GLOBALS["cesta"]."/statistika/import_xml_hlavni.txt";
$soubor = $GLOBALS["cesta"] . "/import/historie_all.xml";

if ($_SESSION["import_xml_hlavni"]) {
    $StatistikaVytvoreno = '';
    $StatistikaZbytek = '';
    $StatistikaDoba = '';
    ...
    $StatistikaZbytek .= nactiXML($soubor);
    ...
    // uložení do sessionu
    $_SESSION["import_xml_hlavni"] = false;
